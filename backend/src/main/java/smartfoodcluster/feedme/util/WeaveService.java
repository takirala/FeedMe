...
public class WeaveService {
    ...
    private static final String APP_USER_ID = "g3smartfoodcluster";
    private static final String CLIENT_ID = "448480889652-j3mk14sk8ouisjg4lboi35qetbtnmupa.apps.googleusercontent.com";
    private static final String CLIENT_SECRET = "MOQUqJObewnk9tyynRWz4SC1";
    private static final String API_KEY = "AIzaSyDxXRuLPwgLebC_tzEleXoJnK8cjFdAOUo";
    ...
    public String run(Weave cmd) {
        final CloudDevices apiClient;
        try {
        ...
        if (devices == null || devices.isEmpty()) {
            ...
            String moisture_device_id = "f25cfd3b-5b46-9250-3bdf-f14649194981";
            ...
            if (cmd.isBlinkFirst())
                sendBlink("LED_ON", apiClient, device.getId());
            else if (cmd.isBlinkSecond())
                sendCommand("LED_OFF", apiClient, device.getId());
            ...
            try {
                ...
                throw new RuntimeException("Could not get device details", e);
            }
            //System.out.println("Available device: \n" + jsonFactory.toPrettyString(devices.get(i)));
        }
    }

    private void sendBlink(String cmd, CloudDevices apiClient, String device_id) {
        boolean led_status = true;
        System.out.println("Sending blink command to the device");


        Map<String, Object> parameters = new HashMap<String, Object>();
        parameters.put("_duration", 0.2);
        parameters.put("_type", "blink");
        Command command = new Command()
                .setName("_ledflasher._animate")  // Command name to execute.
        ...
        try {
            ...
            throw new RuntimeException("Could not insert command", e);
        }
    ...
    private GoogleCredential authorize() throws IOException {
        ...
        String authorizationCode = "4/sBZC6k0vmvDFWHh0a06ifkDxpT8D7UCTbGTXcmrUx68";
